...
const Footer = props => {
    return(
        <footer className=" bg-secondary">
            ...
            <div id="subscribe" className="row mx-0 align-items-center px-5 py-3 ">
                ...
                <div className="col-12 col-md-8 justify-content-around">
                    <form action="" className="w-100 d-flex flex-wrap align-items-center">
                        <input id="email" type="email" placeholder="ilovetotravel@world.com" className="p-2 border-0 my-3 my-lg-0"/>
                        <input id="submit" type="submit" value="Je veux rêver" className="btn btn-danger rounded-0 ml-5 mr-3 py-2 px-4 mb-3 mb-md-0" onClick={(e)=> {e.preventDefault()}}/>
                        <svg id="plane" width="50" height="30" viewBox="0 0 50 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto mx-lg-0">
            ...
            <div id="copyright" className='text-center p-5 bg-danger text-light'>
                <span>- Copyright 2021 - ... en 80 jours -</span>
            </div>
        </footer>
    );
};

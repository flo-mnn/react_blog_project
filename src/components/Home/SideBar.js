...
const SideBar = props => {
    ...
    return(
        <div id="sidebar" className="d-flex flex-column align-items-center bg-secondary pb-5">
            ...
            <div className="subtitle w-100 bg-danger text-center mt-5 mb-5 py-2">
            ...
            <div className="subtitle w-100 bg-danger text-center mt-5 py-4">
                ...
                <p className="text-center px-4 text-light my-2">
                    Ici, à ... en 180 jours, nous aimons réver de nouveaux horizons. Mais plus que rêver, nous aimons les parcourir et les partager avec tous ceux qui partagent la même passion. Le même sentiment d'excitation quand on franchit sa porte (si on en a une), le sac à dos sur l'épaule.
                </p>
